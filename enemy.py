...
class Monster(Enemy):
    def __init__(self, name, x, y, target):
        ...
        for i in range(self.fc1): # idle 이미지 로드
            self.raw_image = PIL.Image.open(f"{img_path}enemy/Monster/{self.name}/idle_{i}.png")
        ...
        for i in range(self.fc2): # walk 이미지 로드
            self.raw_image = PIL.Image.open(f"{img_path}enemy/Monster/{self.name}/walk_{i}.png")
            self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
            self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
            self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
            self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
            ...
            try: # trace 이미지 로드 시도
                self.raw_image = PIL.Image.open(f"{img_path}enemy/Monster/{self.name}/trace_{i}.png")
                self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
                self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
        ...
        for i in range(self.fc3): # attack 이미지 로드
            self.raw_image = PIL.Image.open(f"{img_path}enemy/Monster/{self.name}/atk_{i}.png")
            self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
            self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
            self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
            self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
        ...
        # attacked 이미지 로드
        self.raw_image = PIL.Image.open(f"{img_path}enemy/Monster/{self.name}/atked.png")
        self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
        self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
        self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
        self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
...
class Boss(Enemy):
    ...
    def __init__(self, name, x, y, target):
        ...
        for i in range(self.fc1): # idle 이미지 로드 FC = 0
            self.raw_image = PIL.Image.open(f"{img_path}enemy/Boss/{self.name}/idle_{i}.png")
            self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
            self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
            self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
            self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
        ...
        for i in range(self.fc2): # walk 이미지 로드 FC = 1
            try:
                self.raw_image = PIL.Image.open(f"{img_path}enemy/Boss/{self.name}/walk_{i}.png")
                self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
                self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
        ...
        for i in range(self.fc_a1): # attack 이미지 로드1 FC = 2
            try:
                self.raw_image = PIL.Image.open(f"{img_path}enemy/Boss/{self.name}/atk1_{i}.png")
                self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
                self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
        ...
        for i in range(self.fc_a2): # attack 이미지 로드2 FC = 3
            try:
                self.raw_image = PIL.Image.open(f"{img_path}enemy/Boss/{self.name}/atk2_{i}.png")
                self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
                self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
        ...
        for i in range(self.fc_a3): # attack 이미지 로드3 FC = 4
            try:
                self.raw_image = PIL.Image.open(f"{img_path}enemy/Boss/{self.name}/atk3_{i}.png")
                self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
                self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
        ...
        try:
            self.raw_image = PIL.Image.open(f"{img_path}enemy/Boss/{self.name}/atked.png")
            self.raw_image_flip = self.raw_image.transpose(PIL.Image.FLIP_LEFT_RIGHT)
            self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
            self.resize_image_flip = self.raw_image_flip.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
            self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
        ...
        for i in range(11):
            try:
                self.raw_image = PIL.Image.open(f"{img_path}enemy/Boss/{self.name}/dead_{i}.png")
                self.resize_image = self.raw_image.resize((self.img_size, self.img_size), PIL.Image.NEAREST)
                self.tk_image = PIL.ImageTk.PhotoImage(self.resize_image)
